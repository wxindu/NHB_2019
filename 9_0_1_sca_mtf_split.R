...
x_subset_1 <- list("v7326", "v7325")
x_subset_1_names <- c("TV Weekday", "TV Weekend")

x_subset_2 <- list("v7552", "v7589")
x_subset_2_names <- c("how often social media", "how many hours social media")
#######################################################
# Y Variables
#######################################################
y_1 <-
...
results_mtf_subset_1 <- 
  curve(resultsframe(x_var = x_subset_1, y_var = y_variables_1))

results_mtf_subset_2 <- 
  curve(resultsframe(x_var = x_subset_2, y_var = y_variables_1))
...
save(results_mtf_subset_1, file = "9_0_1_sca_mtf_results_subset1.rda")
save(results_mtf_subset_2, file = "9_0_1_sca_mtf_results_subset2.rda")
