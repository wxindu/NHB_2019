...
ggsave(file="mtf_sfig_full.jpg", plot_number, width = 6, height = 2)
...
x_var <-
  c(
    ...
    "v7381",
    "v7552",
    "tech", "v7544", "v7551", "v7553", "v7589", "v7590", "v7562", "v7563", "tech2"
  )
x_names <-
  c(
    "TV Weekday",
    ...
    "Internet for News",
    "Social Media Use",
    "Technology Mean", "Computer for School",
...
### Save
ggsave(file="mtf_fig_full.pdf", g,
